...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Shape2D shape = new Rectangle(2, 3); //tady to normálně vypočíta naše funkce, protože task přebere ta podtřída
            //Shape2D shape = new Shape2D(); tady to vrátí že tvar ne nedefinovaný
            Console.WriteLine("Area of rectangle: " + rectangle.CalculateArea());
            Console.WriteLine("Area of shpae: " + shape.CalculateArea());

            Cricle cricle = new Cricle(5);
            Console.WriteLine("Area of circle: " + cricle.CalculateArea());
            Console.WriteLine("Aspect ration of circle: " + cricle.CalculateAspectRatio());
            Console.WriteLine("Is point [5,5] containded in circle? " + cricle.ContainsPoint(5,5));
        }
    }
}
